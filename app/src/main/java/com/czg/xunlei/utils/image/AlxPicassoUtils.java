package com.czg.xunlei.utils.image;
...
public class AlxPicassoUtils {
            ...
            public void update(@IntRange(from = 0, to = 100) final int percent, final String url) {
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        //防止listView的控件复用
                        if(!url.equals(progressWheel.getTag(R.id.progress_wheel)) ||! url.equals(textView.getTag(R.id.tv_progress))){
    ...
    public static void displayImageProgress(final String url, ImageView imageView , final ProgressWheel progressWheel, final TextView textView, final String base64Blur){
        ...
        textView.setTag(R.id.tv_progress,url);
        ...
        if(TextUtils.isEmpty(base64Blur))picasso.load(url).placeholder(R.drawable.img_seat).into(imageView, downloadCallBack);
