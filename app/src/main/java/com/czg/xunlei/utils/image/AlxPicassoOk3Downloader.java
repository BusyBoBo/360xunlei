...
/**
 * @author ：czg
 * @class ：AlxPicassoOk3Downloader.class
 * @date ：2017/9/22.
 * @describe ：TODO(input describe)
 */
public class AlxPicassoOk3Downloader implements Downloader{
    ...
    public Response load(Uri uri, int networkPolicy) throws IOException {
        ...
        if ("text/html".equals(php_response.header("Content-Type")) || "text/plain".equals(php_response.header("Content-Type"))) {//如果php发来的是cdn的图片url
            ...
            if (cdn_responseCode >= 300) {
                ...
                throw new Downloader.ResponseException(cdn_responseCode + " " + cdn_response.message(), networkPolicy,
                        cdn_responseCode);
            }
